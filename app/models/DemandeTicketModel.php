...
class DemandeTicketModel {
    ...
    public function save($sujet, $message) {
        ...
        try {
            $query = "INSERT INTO demande_ticket (id_client, sujet, message) VALUES (?, ?, ?)";
            return $this->db->runQuery($query, [$id_client, $sujet, $message]);
        } catch (Exception $e) {
            throw $e;
        }
    }
    ...
    public function updateStatus($id_demande) {
